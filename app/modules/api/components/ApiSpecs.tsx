      ...
      <div className="space-y-2">
        {withLinkToDocs && (
          <Link to="/api/docs" target="_blank">
            <div className="rounded-md border border-transparent px-2 py-1.5 hover:border-gray-200 hover:bg-white">
              <div className="flex items-center justify-between space-x-2">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="truncate text-sm font-medium text-gray-800">View OpenAPI 3.0 Docs</div>
                </div>
              ...
              <div className="rounded-md border border-transparent px-2 py-1.5 hover:border-gray-200 hover:bg-white">
                <div className="flex items-center justify-between space-x-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="truncate text-sm font-medium text-gray-800">Download Postman Collection</div>
                  </div>
                  <ExternalLinkEmptyIcon className="ml-2 h-4 w-4" />
                </div>
              </div>

          ...
          <>
            <div className="w-full space-y-3 text-center">
              ...
              {appConfiguration.auth.authMethods.github.enabled && (
                <div>
                  <a
                    className="focus-visible:ring-ring inline-flex h-9 w-full items-center justify-center whitespace-nowrap rounded-md bg-black px-4 py-2 text-sm font-medium text-white transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50 dark:border dark:border-white/10"

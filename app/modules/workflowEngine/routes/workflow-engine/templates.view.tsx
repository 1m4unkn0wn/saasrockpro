                  ...
                  {filteredItems.map((item) => {
                    return (
                      <button
                        type="button"
                        key={item.title}
                        className="hover:border-theme-300 hover:bg-theme-50 focus:ring-theme-500 flex w-full flex-col items-start overflow-hidden rounded-md border border-gray-300 bg-white text-left shadow-sm hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2"
                        onClick={() => {

    ...
    <SidebarIconsLayout
      ...
      items={[
        ...
        },
        {
          ...
          icon: <CacheIcon className=" h-5 w-5 flex-shrink-0 text-gray-400" aria-hidden="true" />,
          iconSelected: <CacheIcon className=" h-5 w-5 flex-shrink-0 text-gray-500" aria-hidden="true" />,
        },
        {

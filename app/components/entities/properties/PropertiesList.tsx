  ...
  return (
    <div className={clsx(className, "")}>
      ...
      <div className="mt-3">
        <Link
          to={`new`}
          className="focus:ring-ring relative block w-full rounded-lg border-2 border-dashed border-gray-300 px-12 py-6 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2"
        >
          <NewFieldIcon className="mx-auto h-8 text-gray-600" />
          <span className="mt-2 block text-sm font-medium text-gray-900">{t("models.property.actions.add")}</span>
        </Link>
      </div>
